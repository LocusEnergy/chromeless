            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, util_1.uploadToS3(data, 'image/png', options && options.filePath)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, util_1.uploadToS3(data, 'text/html', options && options.filePath)];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        data = _b.sent();
                        if (!util_1.isS3Configured()) return [3 /*break*/, 3];
                        return [4 /*yield*/, util_1.uploadToS3(data, 'application/pdf', filePath)];
