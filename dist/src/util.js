...
function uploadToS3(data, contentType, filePath) {
    return __awaiter(this, void 0, void 0, function () {
        var s3ContentType, s3FilePath, s3Path, s3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    s3FilePath = filePath || cuid();
                    s3Path = "" + getS3ObjectKeyPrefix() + s3FilePath + "." + s3ContentType.extension;
                    s3 = new AWS.S3();
                    return [4 /*yield*/, s3
                            .putObject({
